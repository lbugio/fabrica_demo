...
export default function Telas({ telas }) {
  const tela = { nombre: "", precio:  0, ultimoPrecio:0};
  ...
  useEffect(() => {
    const getTelas = async () => {
      ...
      console.log("🚀 ~ file: index.js ~ line 34 ~ getTelas ~ tela", ultimoPrecio)
      setNewTela({ nombre: tela.nombre, precio: tela.precio, ultimoPrecio: ultimoPrecio});
    };
    if (id) getTelas();
  }, [id, ultimoPrecio]);
